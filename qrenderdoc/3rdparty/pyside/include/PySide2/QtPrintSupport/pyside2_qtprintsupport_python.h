...
#define SBK_QTPRINTSUPPORT_QLIST_INT_IDX                             2 // QList<int >
#define SBK_QTPRINTSUPPORT_QPAIR_QSTRING_QSIZEF_IDX                  3 // QPair<QString, QSizeF >
#define SBK_QTPRINTSUPPORT_QLIST_QPAIR_QSTRING_QSIZEF_IDX            4 // QList<QPair<QString, QSizeF > >
#define SBK_QTPRINTSUPPORT_QLIST_QPRINTER_PAPERSOURCE_IDX            5 // QList<QPrinter::PaperSource >
