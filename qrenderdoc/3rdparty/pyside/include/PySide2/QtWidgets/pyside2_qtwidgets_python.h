...
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                11 // const QVector<int > &
#define SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                       12 // const QHash<int, QByteArray > &
#define SBK_QTWIDGETS_QLIST_QBYTEARRAY_IDX                           13 // QList<QByteArray >
#define SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                          14 // QMap<int, QVariant >
#define SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX                15 // const QList<QPersistentModelIndex > &
#define SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                           16 // QList<QAction * >
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 17 // QMap<QDate, QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_INT_IDX                                  18 // QList<int >
#define SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX                 19 // const QList<QWizard::WizardButton > &
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   20 // QList<QAbstractButton * >
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           21 // QList<QWidget * >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  22 // QList<QTableWidgetItem * >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           23 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   24 // QList<QListWidgetItem * >
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     25 // QList<QMdiSubWindow * >
#define SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                       26 // const QList<QDockWidget * > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   27 // QList<QGraphicsWidget * >
#define SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                         28 // const QList<QKeySequence > &
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                29 // QList<QAbstractAnimation * >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    30 // const QList<QAbstractState * > &
#define SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                           31 // QList<QWindow * >
#define SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                           32 // QList<QScreen * >
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        33 // QPair<qreal, QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  34 // QList<QPair<qreal, QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          35 // QPair<qreal, qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    36 // QList<QPair<qreal, qreal > >
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               37 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     38 // QList<QGraphicsView * >
#define SBK_QTWIDGETS_QLIST_QUNDOSTACKPTR_IDX                        39 // QList<QUndoStack * >
