...
echo.
echo    %BOLD%Downloads a "package_name".rdc file from GCS and runs it on GGP%RESET%
goto :eof
...
ggp ssh put %TEMP%\%package_name%.tgz
...
call gsutil cp gs://renderdoc/shims/ggp/%shim%/libshim_vulkan.so %TEMP%
ggp ssh put %TEMP%\libshim_vulkan.so

:run
echo %GREEN%Running package...%RESET%
ggp run --cmd=main_ggp --application=dedd6c2b56af4830a4ee5c53b0598264aps1 %1 %2 %3 %4 %5 %6 %7 %8 %9
